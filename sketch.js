...
var plank;
var pikachu;
var paddelImage,skyImage,playerImage,coinImage,plankImage,pikachuImage;
var music;
...
function setup(){
  ...
  paddel3.velocityX = 2;
   ...
   paddel4 = createSprite(278,137,30,50);
 ...
 // paddel5.setAnimation("paddel");
  ...
  paddel6.velocityX = -2;
   ...
   player = createSprite (windowWidth/2,windowHeight/2+300,15,30);
...
if(player.isTouching(paddel1)||player.isTouching(paddel2)||player.isTouching(paddel3)||player.isTouching(paddel4)||player.isTouching(paddel5)||player.isTouching(paddel6)){
life=life-1;
player.velocityX=0;
player.velocityY=0;
  if(life<3){
